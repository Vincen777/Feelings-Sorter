...
lista = []
lista.append("@relation tarea-feelings-but-subjetivity\n")
lista.append("\n")
...
for linea in archi.readlines():
    ...
    mensaje = str(linea[0])
    isSubjetive="low"
    if mensaje.find("but")<>-1:
        mensaje= mensaje.split("but")[1]
...
archi.close()
archivo = open("C:/Users/Casa/Desktop/tarea-feelings-but-subjetivity.arff","wb")
